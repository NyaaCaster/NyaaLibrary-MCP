...
见 [`.docs/BLUEPRINT.md`](.docs/BLUEPRINT.md)。核心功能已完成：**M0 基础骨架**、**M1 文档摄取管线**
（上传 / 解析 .txt·.md·.pdf·.docx·.epub·.xls·.xlsx / 分块 / 嵌入 / 稠密+稀疏混合检索）、
**M2 文档管理 UI**（上传、搜索、可排序分页表、文档/分块详情、删除）、
**M3 检索测试与配置**（检索 UI、知识库设置、嵌入模型设置）；当前进行 **M4 打磨与部署**。
